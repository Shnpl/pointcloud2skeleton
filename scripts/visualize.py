...
# #gt
# ax.scatter(x_gt_skeleton, y_gt_skeleton, z_gt_skeleton,'blue')
# for i in range(25):
#     ax.text(x_gt_skeleton[i],y_gt_skeleton[i],z_gt_skeleton[i],i,size=5,color='blue')
# draw_skeleton(ax,np_gt_sk_data,'blue')
#pred
ax.scatter(x_pred_skeleton, y_pred_skeleton, z_pred_skeleton,'red')
for i in range(21):
...
#ax.scatter(x_pc_original, y_pc_original, z_pc_original,color = 'cyan')
